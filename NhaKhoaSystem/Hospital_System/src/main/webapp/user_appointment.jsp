...
<%@page import="com.mysql.cj.protocol.PacketSentTimeHolder"%>
<%
response.setHeader("Case-Control", "no-cache");
response.setHeader("Case-Control", "no-store");
	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 p-5">
				<img alt="" src="img/hinh-anh-anh-bac-si-cuoi.jpg">
			</div>
